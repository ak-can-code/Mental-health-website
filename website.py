...
with st.countainer():
    st.write("- - -")
left-column, right-column = st.colums(2)
with left_column:
        st.subheader("What is Mental Illness?")
        st.write("##")
        st.write(
            """
The National Institute of Mental Health defines mental illness as a mental, behavioral, or emotional disorder. Mental illnesses can vary in impact. Impairment because of the illness can range from, no impairment, mild, moderate, and severe. When a person has severe impairment they are described as having serious mental illness. Mental illness is not the same as poor mental health, often people confuse the two. Mental health is the physical, mental/emotional, and social well being of a person. 
